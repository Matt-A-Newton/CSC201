...
public class ArrayTrainArg {
     ...
     */
    public ArrayTrainArg(int numContainers) {
     ...
     */
    public ArrayTrainArg(String[] train) {
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            new ArrayTrainArg(getNumContainers());
        } else {
            new ArrayTrainArg(args);
        }
    }
}
